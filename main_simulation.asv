...
% Clean architecture - calls functions from separate files
clear; clc; close all;
...
% Create test track (curved line for realistic testing)
track_curve = 0.02 * sin(0.5 * time_vector);  % 2cm amplitude sine wave
...
for ctrl_idx = 1:length(controllers)
    ...
    for i = 1:time_steps+1
        ...
        line_position = track_curve(i);  % Where line is relative to robot
